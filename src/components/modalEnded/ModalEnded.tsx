...
import { selectSetupCorrectAnswer, selectSetupQuestions, selectSetupShowModalEndedModal, setModalEnded, setShow } from '../setupForm/setupFormSlice'
    ...
    const content = endedModal ? 
            <div className='modal-container isOpen'>
                <div className='modal-content'>
                    <h2>congrats</h2>
                    <p>
                        You answered {correctPercent}% of questions correct
                    </p>
                    <button 
                        className='try-again'
                        onClick={playAgain}>
